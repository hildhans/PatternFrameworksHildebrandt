...
class PoodleStartseite : SimplePanel() {
    init {
        this.marginTop = 0.px
    ...
    private fun Container.addFlexPanel1() {
        flexPanel(
            FlexDirection.ROW, FlexWrap.WRAP, io.kvision.core.JustifyContent.CENTER, AlignItems.CENTER,
            spacing = 5
        ) {
    ...
    private fun Container.Lesson1Div(value: String, size: Int): Tag {
        return div(value).apply {
            ...
            hPanel(justify = io.kvision.core.JustifyContent.CENTER, alignItems = AlignItems.FLEXSTART, useWrappers = true, spacing = 50) {
                vPanel(spacing = 10) {
                    marginTop = 30.px
                    width = 200.px
                    padding = 10.px
    ...
    private fun Container.PoolDiv(value: String, size: Int): Tag {
        return div(value).apply {
            ...
            button(I18n.tr("Ausloggen"), style = ButtonStyle.LINK) {
